...
use App\Containers\User\UI\API\Transformers\AddressTransformer;
...
class Controller extends ApiController
{
  ...
  public function createAddress(CreateAddressNewRequest $request)
  {
    $address = Apiato::call('User@CreateAddressAction', [new DataTransporter($request)]);

    return $this->transform($address, UserTransformer::class);
  }
  ...
  public function activateAccount(UpdateUserRequest $request)
  {
    $user = Apiato::call('User@UpdateUserAction', [$request]);
  ...
  public function deleteAddress(CreateAddressNewRequest $request)
  {
    Apiato::call('User@DeleteAddressAction', [$request]);
  ...
  public function searchusers(GetAllUsersRequest $request)
  {
    $users = Apiato::call('User@SearchUserAction', [$request]);

    $user_ = new User();
    return $this->transform($user_->hydrate($users->items()), UserTransformer::class, [], array("pagination" => $users->toArray()));
  }
  ...
  public function getAllAddress(GetAllUsersRequest $request)
  {
    $addresses = Apiato::call('User@GetAllAddressAction',[$request]);
  ...
  {
    $res = Apiato::call('User@ForgotPasswordAction', [new DataTransporter($request)]);
