...
class UserPrivateProfileTransformer extends Transformer
{
  ...
  public function transform(User $user)
  {
    $response = [
      ...
      'av' => DB::select("SELECT * from availabilities where users_id=".$user->id." and availabilities.date >= cast(now() as date) order by date asc"),
  ...
  {
    return $user->speciality_name == null ? null : $this->item($user->specialities, new SpecialityTransformer());
  }
